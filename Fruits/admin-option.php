...
<p><a href="<?php bloginfo('url'); ?>/wp-admin/themes.php?page=functions.php&color=apple">アップル</a>&nbsp;&nbsp;<img src="<?php bloginfo('template_url'); ?>/images/admin/apple.png" /></p>
<p><a href="<?php bloginfo('url'); ?>/wp-admin/themes.php?page=functions.php&color=orange">オレンジ</a>&nbsp;&nbsp;<img src="<?php bloginfo('template_url'); ?>/images/admin/orange.png" /></p>
<p><a href="<?php bloginfo('url'); ?>/wp-admin/themes.php?page=functions.php&color=lemon">レモン</a>&nbsp;&nbsp;<img src="<?php bloginfo('template_url'); ?>/images/admin/lemon.png" /></p>
